...
description: >
  Phân tích break-even giữa vé refundable, non-refundable, semi-flexible — tính xác suất cần đổi/hủy tối thiểu để vé linh hoạt đáng tiền hơn. Dùng khi user so sánh điều kiện hoàn/đổi, lịch chưa chắc chắn, hoặc hỏi "nếu hủy thì sao".
---
