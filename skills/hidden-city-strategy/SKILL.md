...
description: >
  Phân tích hidden city ticketing (xuống ở điểm quá cảnh thay vì bay đến đích) — điều kiện, rủi ro, enforcement theo hãng. CHỈ trigger khi user hỏi trực tiếp về hidden city hoặc skiplagging. Không bao giờ tự đề xuất.
---
...
- **Lưu ý pháp lý**: tại một số quốc gia (đặc biệt EU), hidden city ticketing có thể bị hãng bay kiện đòi bồi thường chênh lệch giá. Lufthansa đã thắng kiện tại Đức năm 2023 về vấn đề này. Luôn nhắc user rằng đây là hành vi vi phạm hợp đồng vận chuyển, dù hiếm khi bị kiện cá nhân.
