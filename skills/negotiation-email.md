...
description: >
  Soạn email thương lượng giá vé máy bay với phòng kinh doanh hãng bay, đúng người nhận, đúng giọng văn, đúng thời điểm. Dùng khi user muốn yêu cầu giảm giá corporate, thương lượng hợp đồng công tác, hoặc đàm phán điều khoản tốt hơn. Trigger khi user đề cập đến "thương lượng", "liên hệ hãng", "yêu cầu giảm giá", "corporate rate", hoặc khi tần suất bay đủ cao để negotiate (>50 chuyến/năm).
---
