...
name: flight-search
description: >
  Tìm vé máy bay từ nhiều nguồn song song (Amadeus, Kiwi, direct), bao gồm virtual interlining ghép 2 hãng thành hành trình rẻ hơn. Dùng khi user muốn tìm vé cụ thể, so sánh hãng, check giá, hoặc hỏi "tìm chuyến bay". Chạy song song với date-optimization khi ngày chưa cố định.
---
