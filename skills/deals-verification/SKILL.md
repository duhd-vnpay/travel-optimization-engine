...
description: >
  Tổng hợp mã giảm giá, promo, deal hiện hành cho vé máy bay kèm mức độ tin cậy (High/Medium/Low). Dùng khi user hỏi về mã giảm giá, promo, deal, hoặc muốn tiết kiệm thêm trước checkout.
---
