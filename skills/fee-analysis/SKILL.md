...
name: fee-analysis
description: >
  Bóc tách phí ẩn (hành lý, ghế, đổi vé) và tính true_total thực phải trả, xếp hạng lại theo giá thực. Dùng khi so sánh LCC vs FSC, khi bị bất ngờ bởi phí checkout, hoặc khi có hãng LCC trong kết quả.
---
